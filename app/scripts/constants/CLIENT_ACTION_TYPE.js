define(function() {
    return {
        "TOGGLE_NOTIFICATIONS_PANEL": "toggle.notifications.panel",
        "OPEN_SERVICE_WINDOW": "open.service.window",
        "OPEN_PLUGIN_WINDOW": "open.plugin.window",
        ...
        "ARRANGE_ALL_WINDOWS": "arrange.all.windows",
        "BROWSER_BLURED": "browser.blured",
        "BROWSER_FOCUSED": "browser.focused",
        "WINDOW_PROMPT": "window.prompt",
        "RESPONSE_WINDOW_PROMPT": "response.window.prompt",
        "RESPONSE_APPLICATION_PROMPT": "response.application.prompt",

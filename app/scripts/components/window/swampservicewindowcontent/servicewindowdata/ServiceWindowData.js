define([
    ...
    function(React, SERVICE_STATE, PROMPTS, SWAMP_MODE, WINDOW_OPEN_TRIGGER, INTERNAL_PLUGINS, SelectBox, OverlayTrigger, Tooltip, clientActions, swampPluginsStore, env) {
